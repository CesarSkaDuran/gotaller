...
@Component({
  ...
  templateUrl: './obs-modal-Facturada.component.html',
  styleUrls: ['./obs-modal-Facturada.component.scss']
})
export class ObsModalServicioFacturadaComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    public dialogRef: MatDialogRef<ObsModalServicioFacturadaComponent>,
