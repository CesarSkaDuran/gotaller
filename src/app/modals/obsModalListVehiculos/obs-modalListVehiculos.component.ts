...
const ELEMENT_DATA: PeriodicElement[] = [
  ...
  { id: '6', cliente: "Felipe Durando", celular: "330000120", modelo: "aks45q4sq48s5d2", placa: "HU54S4" },
  { id: '7', cliente: "Carlos Garcia", celular: "330000120", modelo: "aks45q4sq48s5d2", placa: "HU54S4" },
];

moment.locale('es');

@Component({
  selector: 'app-obs-modal-servicio',
  templateUrl: './obs-modalListVehiculos.component.html',
  styleUrls: ['./obs-modalListVehiculos.component.scss']
})
export class ObsModalListVehiculosComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  constructor(
    public dialogRef: MatDialogRef<ObsModalListVehiculosComponent>,
  ...
  ngOnInit() {
    ...
    if(this.data.vehiculos == 1 ){
    
      this.dataTipoVehiculo = "Entregados"
    
    } else {
    
      this.dataTipoVehiculo = "Inmovilizados"
